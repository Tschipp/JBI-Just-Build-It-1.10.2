...
public abstract class BlockExtraSlab extends BlockSlab {

	public BlockExtraSlab(Material materialIn)
	{
		super(materialIn);
	}
	...
	public BlockExtraSlab(Material materialIn, Block parent, int parentMeta, Block halfSlab)
	{
		super(materialIn);
